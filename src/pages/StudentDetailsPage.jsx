          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-24 mb-4 border-b pb-4">
              <p className="text-left mb-2 border-b pb-2">
                ...
                <a href={studentProfile.linkedinUrl} target="_blank" rel="noreferrer" className="ml-2 text-blue-500 hover:underline">
                  {studentProfile.linkedinUrl}
                </a>
              </p>

              <p className="text-left mb-2 border-b pb-2">
                <strong>Email:</strong> <span className="ml-2 text-blue-500 hover:underline">{studentProfile.email}</span>
              </p>
              ...
              <p className="text-left mb-2 pb-2">
                ...
                <span className="ml-2 text-blue-500 hover:underline">{studentProfile.cohort}</span>
              </p>
            </div>
